  ...
  (function(){
    ...
    var FR = {
      ...
      "c5_m1": `<b>Rôle</b> Designer, chercheur, stratège et vibe coder`,
      "c5_m2": `<b>Client</b> Faris Hytiaa`,
      "c5_m3": `<b>Période</b> 2026`,
      "c5_m4": `<b>Envergure</b> Site web complet conçu à partir de zéro, consolidation de l'information éparpillée`,
      "c5_p1": `Faris Hytiaa est un humoriste de stand-up nommé aux prix Juno. Il n'avait pas de site web. Les diffuseurs, la presse et les fans qui le cherchaient tombaient sur Wikipédia, IMDb et des sites de billetterie de salles. Ses dates de tournée étaient éparpillées entre des publications Instagram, Eventbrite, une liste d'office de tourisme et les billetteries de clubs individuels. Il avait la carrière, mais ses fans n'avaient aucun endroit canonique pour le trouver.`,
      "c5_p2": `J'ai mené un sprint complet, de la recherche au lancement, en 13 heures, à titre de chercheur et de designer, pendant que Claude Code écrivait l'implémentation. D'abord, avec l'aide de Claude, j'ai rassemblé un dossier de recherche complet : chaque crédit, festival, prix, salle et mention de presse au dossier public, triés par niveau de confiance. J'ai fait vérifier l'information par un second agent, puis je l'ai vérifiée moi-même. J'ai monté un guide de design (palette de couleurs, typographie, structure du site) fondé sur cette recherche; par exemple, le site porte son héritage par la couleur et la lumière plutôt que par des drapeaux. Ensuite, j'ai rassemblé les images nécessaires et optimisé le code pour le SEO et le GEO. Mon rôle était de me concentrer sur la stratégie de haut niveau et la vérification pendant que Claude construisait.`,
      "c5_p3": `Un agent produira avec assurance une date de tournée plausible si on le laisse faire, d'où mon souci de vérifier chaque itération. Il dispose maintenant d'une source canonique unique pour ses dates, de données d'événements structurées pour que ces dates apparaissent directement dans la recherche, et d'un transfert documenté pour les mettre à jour sans moi. Depuis le lancement, Faris a signé avec une agence de gestion d'artistes qui m'a acheté le site et le domaine. Elle a conservé ma recherche, mais a réhabillé son site pour l'aligner sur sa marque et le rapprocher des autres humoristes qu'elle représente.`,
      "c5_k1": `de la recherche au prêt-à-lancer`,
      "c5_k2": `langages de code (JavaScript et CSS)`,
      "c5_k3": `site de 6 pages : accueil, à propos, dates, vidéos, boutique, contact`,
      "c5_k4": `appels à l'action : billets, vidéos, réservations`,
