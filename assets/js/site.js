  ...
  (function(){
    ...
    var FR = {
      ...
      "tag_agentic": `Livraison agentielle`,
      "tag_designsys": `Systèmes de design`,
      "tag_arts": `Arts et divertissement`,
      ...
      "cap_walkthrough": `Visite guidée du site <span class="ar">▶</span>`,
      "lock_view": `Verrouillé — contactez-moi pour voir`,
      "c5_h3": `Que devient le rôle du designer quand c'est l'IA qui écrit le code?`,
      "c5_m1": `<b>Rôle</b> Designer, chercheur et responsable technique`,
      "c5_m2": `<b>Client</b> Faris Hytiaa`,
      "c5_m3": `<b>Période</b> 2026`,
      "c5_m4": `<b>Envergure</b> 13 heures · recherche → spécification → construction agentielle`,
      "c5_p1": `Faris Hytiaa est un humoriste de stand-up nommé aux prix Juno qui anime le seul talk-show de fin de soirée au Canada. Il n'avait pas de site web. Les diffuseurs, la presse et les fans qui le cherchaient tombaient sur Wikipédia, IMDb, une place de marché de spectacles corporatifs ou sur la salle qui se classait le mieux cette semaine-là. Ses dates de tournée étaient éparpillées entre des publications Instagram, Eventbrite, une liste d'office de tourisme et les billetteries de clubs individuels, et aucune ne concordait. Pendant ce temps, des revendeurs de billets squattaient déjà les .org et .net de plusieurs humoristes de son calibre. Il avait la carrière; Internet n'avait tout simplement aucun endroit canonique pour le trouver.`,
      "c5_p2": `J'ai mené une démarche complète, de la recherche au lancement, en 13 heures, à titre de chercheur et de designer, pendant que Claude Code écrivait l'implémentation. D'abord un dossier de recherche : chaque crédit, festival, prix, salle et mention de presse au dossier public, triés par niveau de confiance. Cette vérification a révélé quelque chose. Sa propre biographie revendiquait un crédit de festival que la source publiée ne confirmait pas, probablement une confusion de diffusion plutôt qu'une erreur, mais rien à publier sans vérification. Ensuite, un système de design fondé sur l'observation que la prairie albertaine et le désert soudanais partagent une palette, ce qui a permis au site de porter son héritage par la couleur et la lumière plutôt que par des drapeaux. Puis une spécification de construction assez détaillée pour que l'agent puisse l'implémenter sans inventer de faits, chaque affirmation non vérifiée étant marquée comme un espace réservé plutôt que remplie.`,
      "c5_p3": `La spécification, et non le code, était le goulot d'étranglement, et c'est le constat transférable. Rédiger le brief a pris plus de temps que générer le site, parce qu'un agent produira avec assurance une date de tournée plausible si on le laisse faire. Les contrôles qui ont compté étaient structurels : des fichiers de contenu typés plutôt que du texte codé en dur, des espaces réservés entre crochets que l'agent avait pour consigne de ne jamais remplir, et un point de contrôle à chaque affirmation factuelle. Il dispose maintenant d'une source canonique unique pour ses dates, de données d'événements structurées pour que ces dates apparaissent directement dans la recherche, et d'un transfert documenté pour les mettre à jour sans moi.`,
      "c5_k1": `de la recherche au prêt-à-lancer`,
      "c5_k2": `listes éparpillées regroupées en une source canonique`,
      "c5_k3": `dossier de recherche derrière la construction`,
      "c5_k4": `affirmation invérifiable détectée avant la publication`,
