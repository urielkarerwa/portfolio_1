  ...
  (function(){
    ...
    var FR = {
      ...
      "intro_lead": `<span class="hl">Une bonne recherche vous fait gagner du temps</span> et réduit le risque de payer pour tout refaire.`,
      ...
      "intro_d1": `J'utilise tout l'éventail des méthodes qualitatives et quantitatives, en reliant les données comportementales, auto-déclarées et physiologiques pour éclairer les décisions de conception. Je m'intéresse à la conception d'expériences accessibles et responsables, des parcours de service aux produits d'IA, qui atteignent les objectifs d'affaires et résolvent de vrais problèmes humains.`,
      "pb_cap1": `<span class="pb-dot" aria-hidden="true"></span>Présentation des résultats et animation de l'atelier`,
      "pb_cap2": `<span class="pb-dot" aria-hidden="true"></span>Modération d'une étude en direct au Tech3Lab, EEG et oculométrie en cours`,
